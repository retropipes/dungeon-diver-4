...
public class Dungeon implements DungeonConstants {
	...
	this.basePath = System.getProperty("java.io.tmpdir") + File.separator + "DungeonDiver4" + File.separator
		+ randomID + ".dungeon";
	final File base = new File(this.basePath);
	final boolean success = base.mkdirs();
	if (!success) {
	    CommonDialogs.showErrorDialog("Dungeon temporary folder creation failed!", "DungeonDiver4");
	}
    }

    // Static methods
    public static String getDungeonTempFolder() {
	return System.getProperty("java.io.tmpdir") + File.separator + "DungeonDiver4";
    }
	...
	temp.addLevel(DungeonDiver4.getBattleDungeonSize(), DungeonDiver4.getBattleDungeonSize(), 1);
	...
	this.dungeonData.radialScanTimerAction(x, y, z, l, r, targetName, timerMod);
    }
	...
	return this.dungeonData.getCell(row, col, 0, DungeonConstants.LAYER_OBJECT);
    }

    public AbstractDungeonObject getBattleGround(final int row, final int col) {
	return this.dungeonData.getCell(row, col, 0, DungeonConstants.LAYER_GROUND);
    }
    ...
    public void setBattleCell(final AbstractDungeonObject mo, final int row, final int col) {
	this.dungeonData.setCell(mo, row, col, 0, DungeonConstants.LAYER_OBJECT);
    }
    ...
    public void fillLevel(final AbstractDungeonObject bottom, final AbstractDungeonObject top) {
	this.dungeonData.fill(bottom, top);
    }
	...
	final AbstractDungeonObject fillWith = PreferencesManager.getEditorDefaultFill(layer);
	...
	this.dungeonData.fillFloorAndLayerRandomly(this, z, this.activeLevel, layer);
    }
	...
	this.dungeonData.fillFloorAndLayerRandomlyCustom(this, z, this.activeLevel, layer);
    }
    ...
    private void fillLevelRandomlyInBattle(final AbstractDungeonObject pass1FillBottom,
	    final AbstractDungeonObject pass1FillTop) {
	this.dungeonData.fillRandomlyInBattle(this, this.activeLevel, pass1FillBottom, pass1FillTop);
    }
    ...
    private int readDungeonMetafile(final XDataReader reader) throws IOException {
