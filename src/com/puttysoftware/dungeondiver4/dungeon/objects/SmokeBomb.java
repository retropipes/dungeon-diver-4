...
public class SmokeBomb extends AbstractBomb {
	...
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().radialScanTimerAction(x, y, z,
		DungeonConstants.LAYER_OBJECT, AbstractBomb.EFFECT_RADIUS, "Monster", SmokeBomb.STUN_DURATION);
    }
}