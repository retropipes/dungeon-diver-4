...
public class BreakableWallHorizontal extends AbstractWall {
	...
	try {
	    final AbstractDungeonObject left = m.getCell(dirX - 1, dirY, dirZ, DungeonConstants.LAYER_OBJECT);
	...
	try {
	    final AbstractDungeonObject right = m.getCell(dirX + 1, dirY, dirZ, DungeonConstants.LAYER_OBJECT);
