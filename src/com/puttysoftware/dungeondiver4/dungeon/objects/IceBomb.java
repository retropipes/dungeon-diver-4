...
public class IceBomb extends AbstractBomb {
	...
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().radialScanFreezeObjects(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
	// Freeze ground, too
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().radialScanFreezeGround(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
    }
}
