...
public class MonsterObject extends AbstractMovingObject {
	...
	if (DungeonDiver4.getApplication().getMode() != Application.STATUS_BATTLE) {
	    ...
	    DungeonDiver4.getApplication().getDungeonManager().getDungeon().postBattle(this, dirX, dirY, true);
	}
    }
	...
	if (arrowType == ArrowTypeConstants.ARROW_TYPE_ICE) {
	    ...
	    DungeonDiver4.getApplication().getGameManager().morph(new IcedMonster(this.getSavedObject()), locX, locY,
	...
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().updateMonsterPosition(move, dirX, dirY, this);
	this.activateTimer(1);
    }
