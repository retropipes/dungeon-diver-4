...
public class FireBomb extends AbstractBomb {
	...
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().radialScanEnrageObjects(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
	// Burn the ground, too
	DungeonDiver4.getApplication().getDungeonManager().getDungeon().radialScanBurnGround(x, y, z,
		AbstractBomb.EFFECT_RADIUS);
    }
}
