...
public class RotationWand extends AbstractWand {
	...
	int r = 1;
	final String rres = CommonDialogs.showInputDialog("Rotation Radius:", "DungeonDiver4", RotationWand.rChoices,
	...
	final String dres = CommonDialogs.showInputDialog("Rotation Direction:", "DungeonDiver4", RotationWand.dChoices,
	...
	if (d) {
	    DungeonDiver4.getApplication().getGameManager().doClockwiseRotate(r);
	} else {
	    DungeonDiver4.getApplication().getGameManager().doCounterclockwiseRotate(r);
	}
