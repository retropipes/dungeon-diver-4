...
public interface RandomGenerationRule {
    ...
    boolean shouldGenerateObject(Dungeon dungeon, int row, int col, int floor, int level, int layer);
    ...
    boolean shouldGenerateObjectInBattle(Dungeon dungeon, int row, int col, int floor, int level, int layer);
