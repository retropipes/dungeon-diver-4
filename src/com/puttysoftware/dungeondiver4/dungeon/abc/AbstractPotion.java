...
public abstract class AbstractPotion extends AbstractDungeonObject {
    ...
    @Override
    public final void postMoveAction(final boolean ie, final int dirX, final int dirY,
	...
	DungeonDiver4.getApplication().getGameManager().addToScore(AbstractPotion.SCORE_CONSUME);
    }
	...
	DungeonDiver4.getApplication().getGameManager().addToScore(AbstractPotion.SCORE_SMASH);
	return false;
    }
