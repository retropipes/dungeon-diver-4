...
public abstract class AbstractTeleport extends AbstractDungeonObject {
	...
	return DungeonDiver4.getApplication().getDungeonManager().getDungeon().getPlayerLocationW();
    }
	...
	DungeonDiver4.getApplication().showMessage(this.getName() + ": Destination (" + (this.destCol + 1) + ","
