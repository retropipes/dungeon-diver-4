...
public class UndoRedoEngine {
    ...
    public void updateUndoHistory(final AbstractDungeonObject obj, final int x, final int y, final int z, final int w,
	    final int e) {
	this.undoHistory.push(obj, x, y, z, w, e);
    }

    public void updateRedoHistory(final AbstractDungeonObject obj, final int x, final int y, final int z, final int w,
	    final int e) {
	...
	public Link(final AbstractDungeonObject obj, final int x, final int y, final int z, final int w, final int e) {
	    this.mo = obj;
	    this.coordX = x;
	    this.coordY = y;
	    this.coordZ = z;
