...
public class NameEditor extends AbstractObjectEditor {
	...
	this.cachedNames = DungeonDiver4.getApplication().getScenarioManager().getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
	DungeonDiver4.getApplication().getScenarioManager().getNamesFileManager().setNames(this.cachedNames);
    }

    @Override
    public void handleCloseWindow() {
	DungeonDiver4.getApplication().getScenarioManager().getNamesFileManager().saveNames();
	this.exitEditor();
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("Edit Names")) {
			...
			me.create();
			DungeonDiver4.getApplication().getScenarioManager().getNamesFileManager().loadNames();
			me.reSetUpGUI();
			me.edit();
		    }
