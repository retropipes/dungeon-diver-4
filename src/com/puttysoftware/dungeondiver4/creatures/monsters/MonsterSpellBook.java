...
class MonsterSpellBook extends SpellBook {
	...
	spell0Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_CURRENT_HP, 0.85);
	spell0Effect.setDecayRate(Effect.EFFECT_MULTIPLY, StatConstants.STAT_CURRENT_HP, -0.05);
