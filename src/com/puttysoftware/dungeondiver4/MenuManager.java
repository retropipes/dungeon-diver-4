...
public class MenuManager {
    ...
    private JMenuItem editorGoToLocation, editorGoToDestination, editorUpOneFloor, editorDownOneFloor, editorUpOneLevel,
	    ...
	    editorLevelPreferences, editorDungeonPreferences, editorSetStartPoint;
    ...
    private KeyStroke playPlayDungeonAccel, playPlayRandomDungeonAccel, playEditDungeonAccel;
	...
	final ArrayList<AbstractEditor> allEditors = DungeonDiver4.getApplication().getAllEditors();
	...
	this.playPlayRandomDungeonAccel = KeyStroke.getKeyStroke(KeyEvent.VK_P, modKey);
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("New...")) {
		    ...
		    final int result = CommonDialogs
			    .showConfirmDialog("Are you sure you want to reset the current level?", "DungeonDiver4");
