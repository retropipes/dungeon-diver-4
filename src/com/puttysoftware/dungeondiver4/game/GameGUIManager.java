...
class GameGUIManager {
	...
	if (this.vwMgr == null) {
	    this.vwMgr = DungeonDiver4.getApplication().getGameManager().getViewManager();
	    this.setUpGUI();
	}
    }
	...
	if (this.outputFrame.isVisible()) {
		...
		for (y = this.vwMgr.getViewingWindowLocationY(); y <= this.vwMgr
			...
			final AbstractDungeonObject ev = new EmptyVoid().gameRenderHook(y, x, m.getPlayerLocationZ());
	...
	if (this.outputFrame.isVisible()) {
		...
		if (visible) {
			...
			if (u == y && v == x) {
			    ...
			    final AbstractDungeonObject obj5 = obj4.gameRenderHook(y, x, m.getPlayerLocationZ());
	...
	public void keyPressed(final KeyEvent e) {
	    final GameLogicManager glm = DungeonDiver4.getApplication().getGameManager();
